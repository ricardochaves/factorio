...
| [100 × 100 robot-only city block](blueprints/city-block-100x100/) | City blocks | 2 blueprints | [`partial-concrete.txt`](blueprints/city-block-100x100/partial-concrete.txt) · [`full-concrete.txt`](blueprints/city-block-100x100/full-concrete.txt) | in game, 2.0.77 |
<!-- catalog:end -->
